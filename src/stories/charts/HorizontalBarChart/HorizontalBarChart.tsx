      ...
      <svg
        ...
        <Group left={margin} top={margin}>
          ...
          {data.map((d, i) => {
            ...
            // Check if the columnTwoDataType is 'Percentage Part Of Whole'
            } else if (columnTwoDataType === 'Percentage Part Of Whole') {
                ...
                columnTwoValue = ((getValue(d) / totalValue) * 100).toFixed(2) + '%';
            
            // Check if the columnTwoDataType is 'Percentage Segment Against Total'
            } else if (columnTwoDataType === 'Percentage Segment Against Total') {
                ...
                // .toFixed(2) rounds the result to 2 decimal places, and '%' is appended to indicate it's a percentage
                columnTwoValue = ((getValue(d) / Math.max(...data.map(getValue))) * 100).toFixed(2) + '%';
            }
